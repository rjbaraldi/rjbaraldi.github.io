...
\years{2016-2019} UW Applied Mathematics Numerical Analysis Research Club.\\
\hrule
\section*{Teaching}
...
% \hrule
\subsection*{Seminar/Conference Presentations}
\noindent
% \subsubsection*{2016}
\noindent
\years{2022} Robert Baraldi, Drew P. Kouri (2022), ``An Inexact Trust-Region Algorithm for Nonsmooth Nonconvex Regularized Problems'', Centre de recherches math{\'e}matiques Seminar at McGill, October 24, Quebec.\\
\years{2022} Robert Baraldi, Drew P. Kouri (2022), ``An Inexact Trust-Region Algorithm for Nonsmooth Nonconvex Regularized Problems'', GERAD Seminar, October 20, Polytechnique Montr{\'e}al, Quebec.\\
...
\years{2021} Robert Baraldi, Stefan Wild, Sven Lyeffer (2020), ``Using Filter Methods to Guide Convergence for ADMM, with Applications to Nonnegative Matrix Factorization Problems'', SIAM CSE 2021 (virtual), March 1.\\
