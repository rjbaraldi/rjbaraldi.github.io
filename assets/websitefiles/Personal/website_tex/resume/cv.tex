...
\textsc{website}: \href{http://rjbaraldi.github.io}{Personal}, \href{https://www.sandia.gov/ccr/staff/robert-john-baraldi/}{Sandia}.\\
% \vfill
...
\noindent
% \subsection*{Current}
\years{2023-} Senior Computer Science R\&D S\&E, Sandia National Labs. \textbf{Group}: Optimization and Uncertainty Quantification (1463).\\
\years{2021-2023}John von Neumann Postdoctoral Fellow, Sandia National Labs. \textbf{Group}: Optimization and Uncertainty Quantification (1463). \textbf{Postdoctoral Advisor}: \href{https://cfwebprod.sandia.gov/cfdocs/CompResearch/templates/insert/profile.cfm?dpkouri}{Drew P. Kouri}.\\
% \subsection*{Graduate}
...
% \years{2023} Robert Baraldi, Drew P. Kouri (2023), ``Efficient Proximal Subproblem Solvers for a Nonsmooth Trust-Region Method'', \emph{Computational Optimization and Applications}. \\
% \years{2023} Robert Baraldi, Stefan Wild, Sven Leyffer (2023), ``Using Filter Methods to Guide Convergence for ADMM with Applications to Nonnegative Matrix Factorization'', \emph{SIAM Journal on Optimization}.\\
...
\years{2022} Robert Baraldi, Drew P. Kouri (2022), ``\href{https://link.springer.com/article/10.1007/s10107-022-01915-3}{A Proximal Trust-Region Method for Nonsmooth Optimization with Inexact Function and Gradient Evaluations}'', \emph{Mathematical Programming.} 201(1), 1--40.\\
...
\noindent
% \subsubsection*{2014}
\years{2023} Robert Baraldi, Evelyn Herberg, Drew P. Kouri, Harbir Antil (2023), ``Adaptive Randomized Sketching for Dynamic Nonsmooth Optimization'', \emph{Proceedings of the International Model Analysis Conference XLI: Model Validation and Uncertainty Quantification}, \#14609.\\
...
\years{2023} Robert Baraldi, Drew Kouri, Denis Ridzal (2023), ``Trust-Region Methods with Inexact and Adaptive Computations'', \emph{Encyclopedia of Optimization}.
...
\section*{Service}
\years{2019-} Reviewer: Advances in Continuous and Discrete Models, Inverse Problems, SIAM Journal On Scientific Computing, Mathematical Computing, Optimization Letters, Operations Research Letters, SIAM Journal on Optimization. \\
\years{2021-} Minisymposia Organizer: SIAM Optimization (2021), ICCOPT/MOPTA (2022), SIAM CSE (2021,2023).
\hrule
\section*{Teaching/Tutorials}
\years{2023} Sandia + GMU PDECO Seminar \\
