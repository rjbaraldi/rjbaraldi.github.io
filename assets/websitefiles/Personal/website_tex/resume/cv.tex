...
email: \href{mailto:rbaraldi@uw.edu}{rbaraldi@uw.edu}\\
...
\noindent
\subsection*{Graduate}
\years{2018} Lawrence Berkeley National DOE CSGF Lab Practicum: Reduced Order Models and Implicit Sampling. \textbf{Advisor:} \href{https://engineering.nd.edu/profiles/mzahr}{Matthew Zahr}.\\
...
\noindent
% \subsubsection*{2018}
\years{2019} Robert Baraldi, Rajiv Kumar, Aleksandr Aravkin  (2018), “Basis Pursuit Denoise with Nonsmooth Constraints", \emph{IEEE Transactions on Signal Processing} (under revision - preprint \href{https://arxiv.org/abs/1811.11633}{available})\\
