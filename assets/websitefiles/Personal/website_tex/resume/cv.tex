...
% \years{2022} Robert Baraldi, Drew P. Kouri (2022), ``Efficient Proximal Subproblem Solvers for an Inexact Nonsmooth Trust-Region Method'', \emph{Mathematical Programming}.\\
...
\years{2022} Robert Baraldi, Drew P. Kouri (2022), ``A Proximal Trust-Region Method for Nonsmooth Optimization with Inexact Function and Gradient Evaluations'', \emph{Mathematical Programming.}\\
